...
public class SurfaceDraw {
	...
	public void initBuffers() {
		...
		vertexBuffer = ByteBuffer.allocate( 4*size*(matSqure)*10 );
	...
	public void makeSurface( int x1, int y1, int x2, int y2, boolean selecting, Set<Integer> selectFilter ) {
		...
		makeSurface( floatBuffer, selecting, xx1, yy1, xx2, yy2, 0, selectFilter);		
	}
	...
	public void draw( GL gl ) {
		...
		gl.glDrawArrays( GL.GL_TRIANGLES, 0, count/(4*10) );
